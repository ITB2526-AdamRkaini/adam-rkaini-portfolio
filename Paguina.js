...
function saludar() {
  var mensaje = 'Welcome to my portfolio!';
...
document.addEventListener('DOMContentLoaded', function() {
  saludar();
  // Llamada segura a animarArticulosScroll (no existe en todas las páginas)
  if (typeof animarArticulosScroll === 'function') animarArticulosScroll();
